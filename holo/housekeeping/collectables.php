...
while($row = mysql_fetch_assoc($get_rooms)){ ?>
 <tr>
  ...
  <td class='tablerow2'><?php echo htmlspecialchars(stripslashes($row['title'])); ?></div></td>
  <td class='tablerow2' align='center'><?php echo htmlspecialchars(stripslashes($row['description'])); ?></td>
