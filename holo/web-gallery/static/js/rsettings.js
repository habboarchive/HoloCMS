...
return true};var A=function(G,E,F){Wardrobe.add(G,E,F);new Ajax.Request(habboReqPath+"wardrobemyhabbo/store.php",{parameters:{slot:G,figure:E,gender:F},onComplete:function(I,H){if(H.e){alert(L10N.get("profile.figure.wardrobe_invalid_data"))}else{B(G,H.u);$("wardrobe-dress-"+G).show()}}})};return{init:function(){$$("span.wardrobe-dress").invoke("observe","click",Wardrobe.dress);
