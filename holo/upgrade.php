...
if($_GET['do'] == "upgrade"){
	...
	echo "<b>Succesfully upgraded.<br></b>Please delete upgrade.php and install.php.<br>";
	}else{ ?>
Update to the newest database; no data will be lost. This upgrade script will do the following: <ul><li>Add newsletter support</li></ul><br>
<p><a href="upgrade.php?do=upgrade" class="button">Upgrade to newest database!</a></p>
<?php }
